...
usuarios = [
      ("Jair Sampaio", "JS", generate_password_hash("patitofeo").decode('utf-8')),
      ("Rosa Flores", "rosita", generate_password_hash("michifuz").decode('utf-8')),
      ("Yami Moto Nokamina","kamikaze", generate_password_hash("sayonara").decode('utf-8'))
]
